...
<div class="card text-center">
  ...
  <div class="card-body">
    ...
    <a href="pinmanager.php" class="btn btn-primary">PinCode Management</a>
    <a href="certificateupdate.php" class="btn btn-primary">Provide Certificate</a>
  </div>
        ...
        <table summary="This table shows how to create responsive tables using RWD-Table-Patterns' functionality" class="table table-bordered table-hover">
          ...
          <thead>
            ...
            <th data-priority="1">Sno.</th>
              ...
              <th data-priority="4">City $ Center</th>
